...
#define MODULE_CAPTURE_MMW_NAME            "./ModuleMMW"

#define MODULE_NAV_GPS_NAME                   "./ModuleNavGps"
#define MODULE_NAV_GPS_SHOW_NAME              "./ModuleDrawDebug"
...
#define MODULE_RASTERMAP_NAME                 "./ModuleRasterMap"
#define MODULE_OBJECTLIST_NAME                "./ModuleObjectList"
//#define MODULE_INTERSECTION_NAME              "./ModuleIntersection"
...
#define MODULE_CAMOBJ_NAME		"./ModuleCamObj"
#define MODULE_SUB_CONTROLLER_NAME                "./ModuleSubController"
/*
